...
var urls = []string{
	"https://api.tea-fi.com/wallet/check-in?address=0x4843DE5Da8ca1ad89Af95c97DdCA83Ad3b20fFd3",
	"https://api.tea-fi.com/wallet/check-in?address=0x759063c7C357a4fa401be36B9e4db5241adBF0Ac",
}
